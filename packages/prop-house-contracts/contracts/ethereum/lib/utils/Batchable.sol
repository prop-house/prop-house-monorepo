...
abstract contract Batchable {
    ...
    /// @param data List of encoded function calls to make in this contract
    ...
    /// @param response Reverted return response from a delegate call
    function _revertedWithReason(bytes memory response) internal pure {
        assembly {
