...
/**
 * The `RoundConfig` struct type for a timed funding round
 */
// prettier-ignore
export const TIMED_FUNDING_ROUND_CONFIG_STRUCT_TYPE = 'tuple(tuple(uint256,uint256)[],tuple(uint256,uint256[])[],uint40,uint40,uint40,uint16)';

/**
 * The minimum proposal submission period duration
 */
export const MIN_PROPOSAL_PERIOD_DURATION = Time.toSeconds(1, TimeUnit.Days);

/**
 * The minimum vote period duration
 */
export const MIN_VOTE_PERIOD_DURATION = Time.toSeconds(1, TimeUnit.Days);
