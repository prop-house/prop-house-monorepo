...
export class AddCommunities1651459084663 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "community" ("id" SERIAL NOT NULL, "visible" boolean NOT NULL DEFAULT true, "contractAddress" character varying NOT NULL, "name" character varying NOT NULL, "profileImageUrl" character varying NOT NULL, "createdDate" TIMESTAMP NOT NULL, "lastUpdatedDate" TIMESTAMP, CONSTRAINT "PK_cae794115a383328e8923de4193" PRIMARY KEY ("id"))`);
