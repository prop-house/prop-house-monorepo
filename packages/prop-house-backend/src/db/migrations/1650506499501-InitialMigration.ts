...
export class InitialMigration1650506499501 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "vote" ("address" character varying NOT NULL, "signedData" jsonb NOT NULL, "id" SERIAL NOT NULL, "direction" integer NOT NULL DEFAULT '1', "createdDate" TIMESTAMP NOT NULL, "proposalId" integer NOT NULL, "auctionId" integer NOT NULL, "type" integer NOT NULL, CONSTRAINT "PK_2d5932d46afe39c8176f9d4be72" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "proposal" ("address" character varying NOT NULL, "signedData" jsonb NOT NULL, "id" SERIAL NOT NULL, "visible" boolean NOT NULL DEFAULT true, "title" character varying NOT NULL, "who" text NOT NULL, "what" text NOT NULL, "timeline" text NOT NULL, "links" text NOT NULL, "auctionId" integer NOT NULL, "score" numeric NOT NULL DEFAULT '0', "createdDate" TIMESTAMP NOT NULL, "lastUpdatedDate" TIMESTAMP, CONSTRAINT "PK_ca872ecfe4fef5720d2d39e4275" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "file" ("id" SERIAL NOT NULL, "hidden" boolean NOT NULL DEFAULT false, "address" character varying NOT NULL, "name" character varying NOT NULL, "mimeType" character varying NOT NULL, "ipfsHash" character varying NOT NULL, "pinSize" integer NOT NULL, "ipfsTimestamp" character varying NOT NULL, "createdDate" TIMESTAMP NOT NULL, CONSTRAINT "PK_36b46d232307066b3a2c9ea3a1d" PRIMARY KEY ("id"))`);
