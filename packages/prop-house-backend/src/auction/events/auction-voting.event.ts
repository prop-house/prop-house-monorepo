...
export class AuctionVotingEvent implements AuctionTweetable {
...
- ${
        this.auction.community.name
      } house voters can now vote for their favorite props
- Winners will be awarded ${this.auction.fundingAmount} ${
